<?php
// Copyright 2014  Олег ally Попов
...
ET::$languageInfo["Russian"] = array(
	"locale" => "ru-RU",
	"name" => "Русский",
	"description" => "Русский язык для форума Кидо",
...
$definitions["Forum privacy"] = "Конфиденциальность";
...
$definitions["Don't require users to confirm their account"] = "Не требовать от пользователей подтвердить свою учетную запись";
$definitions["Require administrator approval"] = "Требуется одобрения администратора";
$definitions["Don't allow other users to see when I am online"] = "Не разрешать другим пользователям видеть меня, когда я онлайн";
$definitions["Email me when someone mentions me in a post"] = " Сообщить письмом, если меня кто-то упомянул в сообщении";
$definitions["Email me when someone posts in a conversation I have followed"] = "Сообщать письмом, если кто-то ответил в избранном обсуждении";
$definitions["Automatically follow conversations that I reply to"] = "Автоматически добавлять в избранные обсуждение, в котором я участвовал";
$definitions["Automatically follow private conversations that I'm added to"] = "Автоматически добавлять в избранные частное обсуждение, в которое я был добавлен";
...
$definitions["Mark as unread"] = "Отметить как непрочитанное";
...
$definitions["Welcome to esoTalk!"] = "Добро пожаловать на форум Кидо!";
...
// Messages.
$definitions["message.404"] = "На форуме Кидо такой страницы нет. Проверьте ваш запрос или перейдите по другой ссылке.";
...
$definitions["message.connectionError"] = "Форум Кидо не может соединиться с MySQL сервером. Возвращенная ошибка:<br/>%s";
...
$definitions["message.upgradeSuccessful"] = "Форум Кидо успешно обновлен!";
...
$definitions["email.confirmEmail.subject"] = "Форум Кидо. Подтверждение регистрации %1\$s";
...
$definitions["email.forgotPassword.subject"] = "Форум Кидо. Вы забыли ваш пароль, %1\$s?";
...
$definitions["email.mention.subject"] = "Форум Кидо. %1\$s упомянул вас в сообщении";
...
$definitions["email.privateAdd.subject"] = "Форум Кидо. Вас добавили к частному обсуждению";
